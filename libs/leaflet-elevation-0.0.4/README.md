...
Plugin d'élévation : création du thème de Hikster

Créer un fichier less pour le theme de hikster. Il existe déjà des thèmes exemple, on peut partir de un de ces thèmes:
hiksterclientweb/app/libs/leaflet-elevation/src/css/themes/hikster.less

Ajouter le thème dans le Gruntfile. Il y a 3-4 endroits où il faut l'ajouter:
hiksterclientweb/app/libs/leaflet-elevation/Gruntfile.js

Regénérer le plugin d'élévation avec notre thème inclus, le résultat est mis dans le répertoire "dist":
grunt
