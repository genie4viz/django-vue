...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        cssmin: {
            combine: {
                files: {
                    'dist/<%= pkg.name %>-<%= pkg.version%>.css': ['tmp/css/themes/lime.min.css', 'tmp/css/themes/steelblue.min.css', 'tmp/css/themes/purple.min.css', 'tmp/css/themes/hikster.min.css' ],
                    'src/css/L.Control.Elevation.css': ['src/css/themes/lime.css', 'src/css/themes/steelblue.css', 'src/css/themes/purple.css', 'src/css/themes/hikster.css' ]
                }
            },
            minify: {
                expand: true,
        ...
        less: {
            development: {
                files: {
					...
					"src/css/themes/hikster.css": "src/css/themes/hikster.less"
                }
            },
            production: {
                options: {
                ...
                files: {
					...
					"tmp/css/themes/hikster.min.css": "src/css/themes/hikster.less"
                }
            }
        },
        svg2png: {
