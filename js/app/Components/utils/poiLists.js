//the following are the poi items in map object that recursively appear in legend component
var poi = [];

poi['Hébergement / restaurant'] = new Map([
    [
        2, "Abri chauffé"
    ],
    [
...
poi['Stationnement'] = new Map([
    [33, "Stationnement"]
]);

poi['Activité'] = new Map([
    [
        14, "Canot-camping"
    ],
    [
