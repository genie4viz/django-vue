export const mapUtils = {
  ...
  setAttribution() {
    ...
    L.tileLayer(`${tileUrl}?access_token=${accessToken}`, {
      attribution:
        'Imagery from <a href="https://mapbox.com/about/maps/">MapBox</a> &mdash; Map data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
    }).addTo(this.map);

    const attribution = this.map.attributionControl._container.innerHTML;
