...
BEGIN
	...
	select event_id, (ft_elevation_infos(shape_2d, 1)).*  from hike_event where date_insert BETWEEN NOW() - INTERVAL '24 HOURS' AND NOW() or date_update BETWEEN NOW() - INTERVAL '24 HOURS' AND NOW();
