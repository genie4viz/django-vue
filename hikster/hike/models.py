...
class TrailSection(models.Model):
    ...
    shape_2d = models.LineStringField(blank=True, null=True, srid=4326, dim=2, spatial_index=False)
...
class Event(models.Model):
    ...
    shape_2d = models.GeometryField(srid=4326, null=True, default=None, spatial_index=False)  # geom
